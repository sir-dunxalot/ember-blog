...
;require.register("templates/catchall", function(exports, require, module) {
module.exports = Ember.TEMPLATES['catchall'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  data.buffer.push("<h1>Post Not Found</h1>\n\n<hr>\n\n<p>Sorry, the post you are looking for cannot be found.</p>\n\n");
...
;require.register("templates/partials/_published", function(exports, require, module) {
module.exports = Ember.TEMPLATES['partials/_published'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  var buffer = '', helper, options, escapeExpression=this.escapeExpression, helperMissing=helpers.helperMissing;


  data.buffer.push("<p class=\"date\">\n  <span class=\"glyphicon glyphicon-time\"></span>\n  <time pubdate ");
...
;require.register("templates/partials/_social_links", function(exports, require, module) {
module.exports = Ember.TEMPLATES['partials/_social_links'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  var buffer = '', helper, options, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;


  data.buffer.push(escapeExpression((helper = helpers['share-post'] || (depth0 && depth0['share-post']),options={hash:{
    'on': ("facebook")
  },hashTypes:{'on': "STRING"},hashContexts:{'on': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "share-post", options))));
  data.buffer.push("\n");
  data.buffer.push(escapeExpression((helper = helpers['share-post'] || (depth0 && depth0['share-post']),options={hash:{
    'on': ("twitter")
  },hashTypes:{'on': "STRING"},hashContexts:{'on': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "share-post", options))));
...
;require.register("templates/partials/_tags", function(exports, require, module) {
module.exports = Ember.TEMPLATES['partials/_tags'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  var buffer = '', stack1, helper, options;
  data.buffer.push("\n    <li>\n      ");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(2, program2, data),contexts:[depth0,depth0],types:["STRING","ID"],data:data},helper ? helper.call(depth0, "category", "", options) : helperMissing.call(depth0, "link-to", "category", "", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n    </li>\n  ");
  return buffer;
  }
function program2(depth0,data) {
  ...
  data.buffer.push("<ul class=\"tags\">\n  ");
...
function program1(depth0,data) {
  ...
  data.buffer.push("\n\n  ");
  stack1 = helpers['with'].call(depth0, "content", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n\n</header>\n\n<hr>\n\n<div ");
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
    'class': ("mf.postContent")
  },hashTypes:{'class': "STRING"},hashContexts:{'class': depth0},contexts:[],types:[],data:data})));
  data.buffer.push(">\n  ");
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n\n");
  data.buffer.push(escapeExpression((helper = helpers.partial || (depth0 && depth0.partial),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "partials/social_links", options) : helperMissing.call(depth0, "partial", "partials/social_links", options))));
  data.buffer.push("\n\n");
